      ...
      <div className="overflow-x-hidden w-screen h-screen p-10 place-items-center place-content-center bg-gray-100">
        <form className="flex flex-col items-start border-1 border-gray-300 rounded-lg w-1/3 p-10 bg-white">
            ...
            <div className="my-3 w-full">
                ...
                <textarea name="" id="" className="border-1 border-gray-400 rounded-sm w-full px-2 h-20"></textarea>
            </div>
            <div className="my-3 w-full">
            ...
            <div className="my-3">
                <Link href={"#"} className="text-blue-400 underline hover:text-blue-500">Sudah punya akun?</Link>
            </div>
        </form>
      </div>
    </div>
