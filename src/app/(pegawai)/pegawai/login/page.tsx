...
import { BASE_URL, API_LOGIN_PEGAWAI } from "@/lib/env";
...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const loginResponse = await fetch(BASE_URL + API_LOGIN_PEGAWAI, {
        method: "POST",
      ...
      const verifyResponse = await fetch("/api/auth/verify/pegawai", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
